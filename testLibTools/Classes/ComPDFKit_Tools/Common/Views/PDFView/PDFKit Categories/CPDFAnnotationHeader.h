...
static NSString *CPDFAnnotationCaptionKey = @"caption";

static NSString *CPDFAnnotationWidgetCheckStyleKey = @"widgetCheckStyle";

static NSString *CPDFAnnotationWidgetItemsKey = @"items";
...
static NSString *CPDFAnnotationWidgetStringValueKey = @"stringValue";

static NSString *CPDFAnnotationWidgetIsMultilineKey = @"isMultiline";
